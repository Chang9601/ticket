...
export class ServerConfig {
  ...
  */
  ...
  public static readonly ACCESS_TOKEN_SECRET = 'secret'; //get('ACCESS_TOKEN_SECRET',).required().asString();
  public static readonly ACCESS_TOKEN_EXPIRATION = 3600; //get('ACCESS_TOKEN_EXPIRATION').required().asInt();
}
